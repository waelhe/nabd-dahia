...
export default function DailyInfoBar() {
  ...
  return (
    <section className="py-2 bg-gradient-to-r from-purple-600 via-purple-500 to-sky-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-stretch">
            {/* Prayer Section */}
            <div className="flex-1 p-3 border-l border-white/20">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-white/20 rounded-xl">
                  <NextPrayerIcon className="w-5 h-5 text-white" />
                </div>
            ...
            <button
              ...
              className="px-3 flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors"
            >
              {showDetails 
